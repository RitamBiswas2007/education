          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <img 
                src={avatar} 
                alt={fullName}
                className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl object-cover border-2 border-emerald-500/60 shadow-lg shadow-emerald-500/20"
              />
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base sm:text-xl font-bold text-white">{fullName || 'Ayush Member Profile'}</h2>
